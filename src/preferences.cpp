...
PREFS_IMPL_UINT_FIELD(APIUpdateInterval,			"Jenkins/APIUpdateInterval", 10)
...
PREFS_IMPL_BOOL_FIELD(ShowBuildNumber,				"Display/ShowBuildNumber", false)
...
PREFS_IMPL_INT_FIELD(JobsNameDescAlignFlags,		"Display/JobsNameDescAlignFlags", Qt::AlignLeft)
PREFS_IMPL_STRING_FIELD(Font,							"Display/Font", "Arial")
PREFS_IMPL_UINT_FIELD(RunningJobsRedrawTime,		"Display/RunningJobsRedrawTime", 50)
